 ...
 * (https://startbootstrap.com/template-overviews/sb-admin-2) Copyright
 * 2013-2019 Start Bootstrap Licensed under MIT
 * (https://github.com/BlackrockDigital/startbootstrap-sb-admin-2/blob/master/LICENSE)
 */
var token = "token";
var user = "user";
...
$(document).ready(function()
{
	...
	{
		var cookieUser = Cookies.getJSON(user);
		$('#username').html(cookieUser.name);
		$('#avatar').attr('src', cookieUser.avatar);
	}
});
...
!function(t)
{
	...
	t("#sidebarToggle, #sidebarToggleTop").on(
	        ...
	        function(o)
	        {
		        t("body").toggleClass("sidebar-toggled"), t(".sidebar").toggleClass("toggled"), t(".sidebar").hasClass(
		                "toggled")
