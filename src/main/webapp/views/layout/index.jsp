	<%@ page language="java" contentType="text/html; charset=UTF-8"
		...
		<div class='banner_text align-items-center'>
		...
		<h2>
		Hello City We are leader in
		<span>proparties.</span>
		</h2>
		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
		ips eiusmod tempor incididunt ut labore et dolore magna aliqua
		isuspendisse ultrices gravida. Risus.
		</p>
		...
		<li>
		<a class='active' id='Architecture-tab' data-toggle='tab'
		href='#Architecture' role='tab' aria-controls='Architecture'
		aria-selected='true'>Architecture
		</a>
		</li>
		<li>
		<a id='Interior-tab' data-toggle='tab' href='#Interior'
		role='tab' aria-controls='Interior' aria-selected='false'>
		Interior
		</a>
		</li>
		<li>
		<a id='Exterior-tab' data-toggle='tab' href='#Exterior'
		role='tab' aria-controls='Exterior' aria-selected='false'>
		Exterior
		</a>
		</li>
		<li>
		<a id='Landing-tab' data-toggle='tab' href='#Landing'
		...
		<div
		class='row align-items-center justify-content-between tab-pane fade show
		active'
		...
		src='/resource/img/project-1.png' alt=''>
		</div>
		</a>
		...
		<div class='single_portfolio'>
		<img class='img-fluid w-100'
		src='/resource/img/project-2.png' alt=''>
		</div>
		</a>
		<div class='short_info'>
		<p>new Project</p>
		...
		<div class='single_portfolio'>
		<img class='img-fluid w-100'
		src='/resource/img/project-3.png' alt=''>
		</div>
		</a>
		<div class='short_info'>
		<p>Exclusive Project</p>
		...
		<div class='single_portfolio'>
		<img class='img-fluid w-100'
		src='/resource/img/project-5.png' alt=''>
		</div>
		</a>
		<div class='short_info'>
		<p>new Project</p>
		...
		<li>
		<a href=''>
		<span class='flaticon-frame'></span>
		</a>
		2400 sqft
		</li>
		<li>
